...
public class EmoticonFilter extends BaseRichTextFilter {
   ...
   // private static final int[] sSmileResId;
    ...
    static public final String FLAG = "/{";
...
//        sSmileResId = new int[]{
//                R.drawable.wx,  /*微笑*/ R.drawable.dx,  /*大笑*/ R.drawable.tp,  /*调皮*/
//                R.drawable.jy,  /*惊讶*/ R.drawable.pz,  /*撇嘴*/ R.drawable.fn,  /*发怒*/
//                R.drawable.ng,  /*难过*/ R.drawable.hk,  /*很酷*/ R.drawable.kz,  /*口罩*/
//                R.drawable.ot,  /*呕吐*/ R.drawable.se,  /*色*/ R.drawable.tx,  /*偷笑*/
//                R.drawable.ka,  /*可爱*/ R.drawable.by,  /*白眼*/ R.drawable.am,  /*傲慢*/
//                R.drawable.kun,  /*困*/ R.drawable.hp,  /*害怕*/ R.drawable.lh,  /*流汗*/
//                R.drawable.kx,  /*开心*/ R.drawable.cy,  /*抽烟*/ R.drawable.ll,  /*流泪*/
//                R.drawable.fd,  /*奋斗*/ R.drawable.yw,  /*疑问*/ R.drawable.xu,  /*嘘*/
//                R.drawable.yun,  /*晕*/ R.drawable.zs,  /*衰*/ R.drawable.kul,  /*骷髅*/
//                R.drawable.qd,  /*敲打*/ R.drawable.bb,  /*拜拜*/ R.drawable.dy,  /*得意*/
//                R.drawable.zt,  /*猪头*/ R.drawable.bz,  /*闭嘴*/ R.drawable.yb,  /*拥抱*/
//                R.drawable.dai,  /*发呆*/ R.drawable.sj,  /*睡觉*/ R.drawable.hx,  /*害羞*/
//                R.drawable.gz, /* 鼓掌 */R.drawable.kb, /* 抠鼻 */R.drawable.kl, /* 可怜 */
//                R.drawable.qq, /* 亲亲 */R.drawable.wq, /* 委屈 */R.drawable.yx, /* 阴险 */
//                R.drawable.zk, /* 抓狂 */R.drawable.bs, /* 鄙视 */R.drawable.bq, /* 抱拳 */
//                R.drawable.ok, /* ok */ R.drawable.zan, /* 赞 */ R.drawable.ruo, /* 弱 */
//                R.drawable.ws, /* 握手 */R.drawable.sl, /* 胜利 */R.drawable.mg, /* 玫瑰 */
//                R.drawable.kw, /* 枯萎 */R.drawable.wen, /* 吻 */R.drawable.xd, /* 心动 */
//                R.drawable.xs, /* 心碎 */R.drawable.lw, /* 礼物 */R.drawable.sd, /* 闪电 */
//                R.drawable.zd, /* 炸弹 */R.drawable.dao, /* 刀 */R.drawable.cc, /* 臭臭 */
//        };
        ...
        nSmileCodes = new String[] {
                "/{nbq", /* 新抱拳 */"/{ncy", /* 新抽烟 */"/{nse", /* 新色 */
                "/{nxd", /* 新心动 */"/{nyb", /* 新拥抱 */"/{nkb", /* 新抠鼻 */
                "/{nku", /* 新哭 */  "/{not", /* 新呕吐 */"/{sjt", /* 上箭头 */
                "/{xjt", /* 下箭头 */"/{zjt", /* 左箭头 */"/{yjt", /* 右箭头 */
                "/{nbs", /* 新鄙视 */"/{ndx", /* 新大笑 */"/{ngz", /* 新鼓掌 */
                "/{nhx", /* 新害羞 */"/{nlh", /* 新流汉 */"/{nzs", /* 新衰*/
                "/{nsj", /* 新睡觉 */"/{ntx", /* 新偷笑 */"/{nwx", /* 新微笑*/
                "/{nwq",  /* 新委曲 */
        };

//        nSmileResId = new int[] {
//                R.drawable.nbq,  /*新抱拳*/ R.drawable.ncy,  /*新抽烟*/ R.drawable.nse,  /*新色*/
//                R.drawable.nxd,  /*新心动*/ R.drawable.nyb,  /*新拥抱*/ R.drawable.nkb,  /*新抠鼻*/
//                R.drawable.nku,  /*新哭*/ R.drawable.not,  /*新呕吐*/ R.drawable.sjt,  /*上箭头*/
//                R.drawable.xjt,  /*下箭头*/ R.drawable.zjt,  /*左箭头*/ R.drawable.yjt,  /*右箭头*/
//                R.drawable.nbs,  /*新鄙视*/ R.drawable.ndx,  /*新大笑*/ R.drawable.ngz, /*新鼓掌*/
//                R.drawable.nhx,  /*新害羞*/ R.drawable.nlh, /* 新流汉 */R.drawable.nzs, /* 新衰*/
//                R.drawable.nsj,  /* 新睡觉 */R.drawable.ntx,/* 新偷笑 */R.drawable.nwx, /* 新微笑 */
//                R.drawable.nwq,  /* 新委曲 */
//        };
...
//        };
    ...
    public static class SmileCompare implements Comparable<SmileCompare> {
        ...
        public int compareTo(SmileCompare o) {
            ...
            while (pos < Src.mKeyLength && pos < Obj.mKeyLength) {
...
//        parseSpannableNew(context, spannable, maxWidth, tag);
    ...
    public static float parseToBitmap(Context context, Canvas canvas, String text, float x, float y, int width, int height, Paint paint, int smileType) {
        if (smileType == SMILE_TYPE_GENERAL) {
            ...
            return parseToBitmapInternal(context, canvas, text, x, y, width, height, paint, nSmileOrderSet);*/
    ...
    private void parseSpannableAllNew(Context context, Spannable spannable, int maxWidth, int normalWidth, Object tag) {
        ...
        while (true) {
            ...
            SmileItem s = SmileCompare.sSearch.mItem;
            Drawable drawable;
            if(normalWidth != Integer.MAX_VALUE && normalWidth > 0) {
    ...
    private void parseSpannableNew(Context context, Spannable spannable, int maxWidth, Object tag) {
        ...
        while (true) {
            ...
            ImageSpan imageSpan = new ImageSpan(s.mDrawable);
            setSpannable(imageSpan, spannable, span, span + s.mText.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            span += s.mText.length();
        }
    }
    ...
    public static int parseSpannableLengthWithNum(String str, int num, boolean useOld) {
        ...
        while (true) {
            ...
            SmileCompare.sTemp.mKeyBase = span + 2;
            SmileCompare.sTemp.mKeyLength = len - span - 2;
            if(useOld && !sSmileOrderSet.contains(SmileCompare.sTemp) && !nSmileOrderSet.contains(SmileCompare.sTemp)) {
                span += 2;
                continue;
