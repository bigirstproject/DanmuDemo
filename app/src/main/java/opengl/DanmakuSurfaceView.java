...
/**
 */
public class DanmakuSurfaceView extends GLSurfaceView {
    ...
    private DanmakuSurfaceViewRenderer mRenderer;//渲染器
    ...
    private Runnable scheduRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if (scheduledTask != null) {
                scheduledTask.scheduledDelayed(scheduRunnable, 1000);
            }
        }
    };
...
//        mCachedDanmaku = new LinkedList<>();
        ...
        mRenderer = new DanmakuSurfaceViewRenderer(context, this);
        ...
        mRenderer.setListener(new DanmakuSurfaceViewRenderer.RenderListener() {
            @Override
...
//        }
//
//        DanmuItem danmaku = new DanmuItem(danmakuItem.getDanmakuBitmap());
